...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow border-top border-5 border-primary sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <h4 class="m-0 pe-lg-5 d-none d-lg-block"><i class="fa fa-headphones text-primary me-3"></i>+1 303-944-7371
            </h4>
        </div>
    </nav>
    <!-- Navbar End -->
    ...
    <div class="col-10 col-lg-8">
        <h5 class="text-white text-uppercase mb-3 animated slideInDown">Transport & Logistics Simplified</h5>
        <h1 class="display-3 text-white animated slideInDown mb-4">#1 Solution For Your <span class="text-primary">Logistics Needs</span></h1>
        <p class="fs-5 fw-medium text-white mb-4 pb-2">Experience a new level of efficiency and reliability in transportation. Our dedicated team ensures a seamless experience from start to finish. Contact us today to get started.</p>
        <a href="#" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Learn More</a>
        <a href="#" class="btn btn-secondary py-md-3 px-md-5 animated slideInRight">Request a Quote</a>
    </div>
</div>
    ...
    <div class="container about py-5 px-lg-0">
        <div class="row g-5 mx-lg-0">
            ...
            <div class="col-lg-6 about-text wow fadeInUp" data-wow-delay="0.3s">
                ...
                <p class="mb-5">Experience a new level of efficiency and reliability in transportation. Our dedicated team ensures a seamless experience from start to finish. Contact us today to get started.</p>
